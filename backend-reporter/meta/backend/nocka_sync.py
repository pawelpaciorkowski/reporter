...
POMIN_ZAWSZE = 'SWIECIE ZAMOSC PRZ-PLN PRZ-KUT PRZ-SIE PINCZOW MIECHOW JEDRZEJ LABTEST'.split(' ')
POMIN_TIMEOUT = ''.split(' ')
STARA_BAZA = 'HISTZDU JEDRZEJ HISTMSW HISTGDY HISTPOZ LUBINSE ELK PRABUTY'.split(' ')
