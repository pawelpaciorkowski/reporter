...
SQL = 'select * from raporty_reporter.czy_przetwarzamy_dane_osobowe2(%s)'
...
def tables_from_multisync(task_params):
    ...
    adres = telefon = email = zew = wyciek = False
    ...
    if len(data) == 0:
        ...
        result.append({
            ...
            'data': [
                ...
                {'title': 'w wyciekach danych', 'value': 'Tak' if wyciek else 'Nie'},
            ]
        })
        result.append({
